...
Иконки плеера используются с опорой на [anilibria-app](https://github.com/anilibria/anilibria-app).
...
Разработчики этого приложения не аффилированы с контентом, доступным в приложении, и не хранят и не распространяют этот контент. Приложение следует рассматривать как веб-браузер: всё содержимое, доступное через него, свободно доступно в интернете. Все запросы на удаление контента по DMCA следует направлять владельцам сайта, на котором этот контент размещён.
