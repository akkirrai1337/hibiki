package org.akkirrai.hibiki.app.shell.runtime
...
import org.akkirrai.hibiki.app.shell.settings.HibikiSettingsActions
...
import org.akkirrai.hibiki.app.settings.saveHibikiAppSettings
...
internal fun rememberHibikiAppShellResources(
    ...
    libraryListState = rememberSaveable(saver = LazyListState.Saver) { LazyListState() },
