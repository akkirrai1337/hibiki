...
fun DetailsStaffSection(
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        ...
        LazyRow(
            ...
            items(directors.distinct(), key = { it }) { director ->
                Surface(
                    ...
                    Box(modifier = Modifier.padding(horizontal = DetailsGenresItemHorizontalPadding), contentAlignment = Alignment.Center) {
                        Text(text = director, style = MaterialTheme.typography.labelMedium, color = MaterialTheme.colorScheme.onSurface)
                    }
                }
            }
        }
