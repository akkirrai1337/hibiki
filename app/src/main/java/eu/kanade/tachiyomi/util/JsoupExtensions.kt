...
/** Reads the body once unless an already-consumed HTML string is supplied. */
fun Response.asJsoup(html: String? = null): Document {
    val source = html ?: body?.string().orEmpty()
    return Jsoup.parse(source, request.url.toString())
}
